...
const alert = ({ payload }) => {
  ...
  return (
    <>
      <div
        className={`flex items-center mt-4 mb-4 border-2 rounded-md bg-white h-150 ${borderColor}`}
      >
        {/* Your content goes here */}
        {/* Left side with red background and icon */}
        <div
          className={`flex items-center justify-center w-12 min-h-[100px] ${backgroundColor}`}
        >
